...
export default function Features() {
  return (
    <div className="min-h-screen w-full flex items-center gap-8 md:flex-row flex-col justify-between">
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
              Our coming story of our unity, team work and moderation when doing
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-lime-100 text-lime-500 mb-5 flex-shrink-0">
                <svg
                  fill="none"
                  stroke="currentColor"
