...
export default async function Home() {
  ...
  <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 
      ...
      text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Contact Us</h1>
          ...
          py-4 px-10 text-base bg-lime-400 dark:bg-lime-500 rounded-lg text-center text-gray-900">
                        ...
                        <a href="https://stencukpage.com/" className="dark:text-white hover:brightness-90 ml-4 font-bold inline-flex justify-center items-center 
          py-4 px-10 text-base bg-lime-400 dark:bg-lime-500 rounded-lg text-center text-gray-900">
